...
IS
  ...
  BEGIN
      ...
      LOOP
        INSERT INTO INVOICES VALUES (X.CONTRACTID ,TO_NUMBER(TO_CHAR(TO_DATE(BILLING_DATE_INPUT, 'MON-YYYY'), 'MM'), '99'), TO_NUMBER(TO_CHAR(TO_DATE(BILLING_DATE_INPUT, 'MON-YYYY'), 'YYYY'), '9999') , SYSDATE, BILL(X.CLIENTID, BILLING_DATE_INPUT, X.CONTRACT_TYPE ));
      END LOOP;
  END;
/
