...
CREATE TABLE PURCHASEDTVSERIES
  (
    ...
    CONSTRAINT CK_PURCHASEDTVSERIES CHECK (EPISODE <= FK_PURCHASEDTVSERIES1.EPISODES)
  ) ;
...
CREATE TABLE TVSERIESLICENSES
  (
    ...
    CONSTRAINT CK_TVSERIESLICENSES CHECK (EPISODE <= FK_TVSERIESLICENSES1.EPISODES)
  ) ;
