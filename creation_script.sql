...
CREATE TABLE Movies
  (
   ...
   CONSTRAINT CK_movies6 CHECK (TITLE_YEAR >= TO_DATE(1895, 'YYYY')) ,
...
CREATE TABLE TVSeries
  (
   ...
   CONSTRAINT CH_TVseries2 CHECK (SEASON >= 0) ,
   CONSTRAINT CH_TVseries2 CHECK (AVGDURATION >= 0) ,
   CONSTRAINT CH_TVseries2 CHECK (EPISODES >= 0) ,
  ) ;
