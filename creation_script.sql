...
CREATE TABLE TapsMovies
  (
    ...
    CONSTRAINT FK_TapsMovies2 FOREIGN KEY (Title, Duration) REFERENCES Movies(MOVIE_TITLE, Duration) ,
    CONSTRAINT CK_TapsMovies1 CHECK (DURATION >= 0) ,
    CONSTRAINT CK_TapsMovies2 CHECK (VIEWPCT BETWEEN 0 AND 100)
  );
