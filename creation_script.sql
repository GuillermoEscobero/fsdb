...
CREATE TABLE TAPSTV
  (
    ...
    TITLE_SERIES  VARCHAR2(100 CHAR) ,
    DURATION NUMBER(3) ,
    SEASON   NUMBER(3) ,
    EPISODE  NUMBER(3) ,
    VIEWDATE DATE ,
    VIEWPCT  NUMBER(3) NOT NULL ,
    CONSTRAINT PK_TAPSTV PRIMARY KEY (CLIENT, TITLE_SERIES, VIEWDATE, SEASON, EPISODE) ,
    CONSTRAINT FK_TAPSTV1 FOREIGN KEY (CLIENT) REFERENCES CLIENTS(CLIENTID) ,
    CONSTRAINT FK_TAPSTV2 FOREIGN KEY (TITLE_SERIES, SEASON) REFERENCES TVSERIES(TITLE, SEASON) ,
