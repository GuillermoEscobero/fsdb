...
CREATE TABLE TAPSTV
  (
    ...
    DEVICE   VARCHAR2(15 CHAR) DEFAULT '' NOT NULL ,
...
CREATE TABLE TAPSMOVIES
  (
    ...
    DURATION NUMBER(3) NOT NULL ,
    VIEWPCT  NUMBER(3) NOT NULL ,
    CONSTRAINT PK_TAPSMOVIES PRIMARY KEY (CLIENT, DEVICE, VIEWDATE) ,
    CONSTRAINT U_TAPSMOVIES UNIQUE (CLIENT, VIEWDATE, TITLE) ,
