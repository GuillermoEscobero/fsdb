...
FOR X IN active_contracts
LOOP
  DELETE FROM TAPS_MOVIES WHERE CONTRACTID=X.CONTRACTID AND TO_CHAR(VIEW_DATETIME, 'HH')=TO_CHAR(SYSDATE-(3/24), 'HH') AND PCT=91 AND TITLE='Avatar';
  DELETE FROM TAPS_SERIES WHERE CONTRACTID=X.CONTRACTID AND TO_CHAR(VIEW_DATETIME, 'HH')=TO_CHAR(SYSDATE-(3/24), 'HH') AND PCT=91 AND TITLE='House' AND SEASON=1 AND EPISODE=1;
  DELETE FROM TAPS_SERIES WHERE CONTRACTID=X.CONTRACTID AND TO_CHAR(VIEW_DATETIME, 'HH')=TO_CHAR(SYSDATE-(3/24), 'HH') AND PCT=91 AND TITLE='Sherlock' AND SEASON=1 AND EPISODE=1;
  DELETE FROM TAPS_SERIES WHERE CONTRACTID=X.CONTRACTID AND TO_CHAR(VIEW_DATETIME, 'HH')=TO_CHAR(SYSDATE-(3/24), 'HH') AND PCT=91 AND TITLE='Columbo' AND SEASON=1 AND EPISODE=1;
END LOOP;
