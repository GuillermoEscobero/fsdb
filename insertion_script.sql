...
INSERT INTO TapsTV (CLIENT, TITLE, DURATION, SEASON, EPISODE, VIEWDATE, VIEWHOUR, VIEWPCT)
SELECT CLIENT, TITLE, TO_NUMBER(DURATION), TO_NUMBER(SEASON), TO_NUMBER(EPISODE), TO_DATE(VIEWDATE, 'YYYY-MM-DD'), TO_DATE(VIEWHOUR, 'HH24:MI'), TO_NUMBER(SUBSTR(VIEWPCT, 1, INSTR(VIEWPCT, '%')-1), '999') FROM FSDB.OLD_TAPS WHERE SEASON IS NOT NULL ;
